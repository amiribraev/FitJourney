...
function RegisterForm() {
    ...
    async function onSubmit(data) {
        ...
        try {
            ...
            const errorMessage = error.code === 'auth/email-already-in-use' ? 'Этот email уже используется. Пожалуйста, войдите или используйте другой адрес.' : `Произошла ошибка при регистрации.`;
...
//# sourceMappingURL=src_7fae2891._.js.map